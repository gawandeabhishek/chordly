...
const User = () => {
  return (
    <div className="flex min-h-[calc(100vh-10rem)] items-center mt-10 flex-col sm:flex-row gap-4 justify-center w-full">
      <img
      ...
      />
      <div className="gap-6 flex w-full items-center justify-center text-center flex-col">
        ...
        <p className="flex items-center justify-center font-semibold text-sm sm:text-xl text-slate-800 ltr cursor-pointer">
            <span className="flex items-center justify-center gap-4 bg-pink-500 dark:bg-rose-600 h-10 px-4 text-slate-100 dark:text-slate-200 rounded-s-full">Followers <UserPlus /></span>
            <span className="flex items-center justify-center bg-slate-500/10 text-slate-800 dark:text-slate-200 h-10 px-4 rounded-e-full">100k+</span>
        </p>
      </div>
    </div>
  );
